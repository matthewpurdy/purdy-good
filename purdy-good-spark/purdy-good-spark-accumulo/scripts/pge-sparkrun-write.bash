...
echo     --class purdygood.spark.accumulo.SparkAccumuloWriteRun $target_path/purdy-good-spark-accumulo-1.0.0.jar
echo "$@"
...
$SPARK_HOME/bin/spark-submit                                                     \
     ...
     --class purdygood.spark.accumulo.SparkAccumuloWriteRun $target_path/purdy-good-spark-accumulo-1.0.0.jar $@
